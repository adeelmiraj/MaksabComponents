    ...
    public var isLight: Bool = true{
        didSet{
            if isLight{
                ...
                userName.textColor = UIColor.appColor(color: .DarkText)
                carName.textColor = UIColor.appColor(color: .DarkText)
                price.textColor = UIColor.appColor(color: .DarkText)
            }else{
                self.backgroundColor = UIColor.appColor(color: .Dark)
                userName.textColor = UIColor.appColor(color: .LightText)
                carName.textColor = UIColor.appColor(color: .LightText)
                price.textColor = UIColor.appColor(color: .LightText)
            }
        }
    }
